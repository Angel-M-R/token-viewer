...
const ACTIVE_PUBLISHER_MACHINES = new Set(["angel-mac", "aon-mac-m5"]);
...
async function main(argv) {
  ...
  if (!ACTIVE_PUBLISHER_MACHINES.has(options.machine)) {
    throw new Error("--machine must be angel-mac or aon-mac-m5");
  }
...
function printUsage() {
  ...
  node ops/macos/install-launchd.mjs --machine <angel-mac|aon-mac-m5> --checkout <absolute-path> [--hour 9] [--minute 0] [--path <PATH>] [--dry-run]
`);
}
