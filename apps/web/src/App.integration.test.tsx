...
describe("local dashboard integration", () => {
  ...
  it("renders every local aggregate view from snapshots without API or public-host configuration", async () => {
    ...
    expect(screen.getByLabelText("aon-mac Copilot quota gauge")).toBeInTheDocument();
    expect(screen.getByLabelText("aon-mac-m5 Copilot quota gauge")).toBeInTheDocument();
