...
Cada ejecución de una identidad activa SHALL descubrir todo el histórico aún disponible en sus fuentes locales, crear cualquier día ausente de su máquina y regenerar el día UTC abierto. Los días cerrados ya válidos MUST permanecer inmutables salvo una operación explícita de reparación. La generación MUST deduplicar registros en memoria antes de agregar. `old-mac` MUST quedar excluida de esta operación porque sus snapshots agregados ya importados constituyen su histórico completo disponible.
