...
**Migration**: Usar una reparación explícita de snapshots con revisión y validación.

#### Scenario: Sin reprice remoto
- **WHEN** cambia el catálogo
- **THEN** no existe una operación HTTP que reescriba automáticamente el histórico
